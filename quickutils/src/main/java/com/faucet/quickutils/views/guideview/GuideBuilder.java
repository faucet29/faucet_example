package com.faucet.quickutils.views.guideview;
 ...
 * </p>
 * <p>
 * 接下来是在相对于这个targetRect的区域绘制一些图片或者文字。我们把这样一张图片或者文字抽象成一个Component接口,设置文字或者图片等
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，y偏移量,。
 * </p>
 * <p>
